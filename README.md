...
![Representative Table](images/rep_table.png) Visual evidence here, indicate uneven performance across sales representatives, with some showing consistent growth while others experience declining trends over the three-year period. 

Yearly Performance Table
![Representative Table](images/Yearly_Summary_Table.png)

Overall Analysis
![Representative Table](images/Overall_Analysis.png)
